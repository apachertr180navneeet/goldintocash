...
<section class="cta-release">
    <div class="cta-inner">
        <div class="cta-content">
            ...
            <p class="cta-sub">
                Fast • Safe • Stress-free. Hum aapka sona wapas dilwane mein aapke saath hain.
            </p>
    ...
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <p class="mb-4">
                    Fast, reliable, and transparent, we provide top market prices for your gold, instant cash
                    payouts, and a friendly, hassle-free experience you can trust every time.
                </p>
                <div class="row g-3">
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="position-relative rounded overflow-hidden h-100" style="min-height: 100%">
                    <img class="img-fluid" src="{{ asset('website/img/gold-into-cash1.webp') }}" alt="" style="object-fit: cover" />
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-lg-7 wow fadeIn" data-wow-delay="0.3s">
                        ...
                        <div class="bg-white rounded p-3">
                            <div class="d-flex align-items-center bg-primary rounded p-3">
                                <img class="flex-shrink-0 rounded-circle me-3" src="{{ asset('website/img/profile.jpg') }}" alt="" />
                                <h5 class="text-white mb-0">Call Us: +91 97979 79812</h5>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row banner">
            ...
            <div class="col-lg-6 card" role="region" aria-label="Gold to Cash">
                ...
                <p class="sub">
                    Tension mat lo… sona aapka hai, hum bas usse wapas dilwane me madad karte hain.
                </p>
